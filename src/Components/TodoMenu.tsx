    ...
    <>
      ...
      <Menu shadow="md" width={200}>
        ...
        <Menu.Dropdown>
          ...
          <Menu.Item icon={<Pencil size={14} />} component='button' onClick={() => setModifyModalOpened(true)}>modify todo</Menu.Item>
          <Menu.Item icon={<Trash size={14} />} color='red' component='button' onClick={onDeleteTodoClicked}> delete todo</Menu.Item>
        </Menu.Dropdown>
      </Menu>
    </>
